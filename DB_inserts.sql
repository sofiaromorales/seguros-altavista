...
insert into SUCURSAL (cod_sucursal, nb_sucursal, cod_ciudad) values (10, 'Correduría de Seguros Madrid', 9);
...
insert into SUCURSAL (cod_sucursal, nb_sucursal, cod_ciudad) values (16, 'Experta Seguros Buenos Aires', 14);
insert into SUCURSAL (cod_sucursal, nb_sucursal, cod_ciudad) values (17, 'Río Uruguay Seguros Rosario', 15);
insert into SUCURSAL (cod_sucursal, nb_sucursal, cod_ciudad) values (18, 'San Cristóbal Seguros Generales', 16);
insert into SUCURSAL (cod_sucursal, nb_sucursal, cod_ciudad) values (19, 'Seguros La Nueva', 17);
insert into SUCURSAL (cod_sucursal, nb_sucursal, cod_ciudad) values (20, 'HIR Seguros', 18);
insert into SUCURSAL (cod_sucursal, nb_sucursal, cod_ciudad) values (21, 'Vision Digna', 18);
insert into SUCURSAL (cod_sucursal, nb_sucursal, cod_ciudad) values (22, 'Inbursa', 19);
insert into SUCURSAL (cod_sucursal, nb_sucursal, cod_ciudad) values (23, 'Aseguralos', 20);
insert into SUCURSAL (cod_sucursal, nb_sucursal, cod_ciudad) values (24, 'Seguros y Fianzas Trujillo', 21);
insert into SUCURSAL (cod_sucursal, nb_sucursal, cod_ciudad) values (25, 'Acurio & Asociados', 22);
insert into SUCURSAL (cod_sucursal, nb_sucursal, cod_ciudad) values (26, 'DC Seguros', 23);
insert into SUCURSAL (cod_sucursal, nb_sucursal, cod_ciudad) values (27, 'Aseguradora Magallanes', 25);
insert into SUCURSAL (cod_sucursal, nb_sucursal, cod_ciudad) values (28, 'Mutual de Seguros de Chile', 26);
insert into SUCURSAL (cod_sucursal, nb_sucursal, cod_ciudad) values (29, 'Seguros Farmers', 27);
insert into SUCURSAL (cod_sucursal, nb_sucursal, cod_ciudad) values (30, 'Business Insurance', 28);
insert into SUCURSAL (cod_sucursal, nb_sucursal, cod_ciudad) values (31, 'New York Life', 29);
insert into SUCURSAL (cod_sucursal, nb_sucursal, cod_ciudad) values (32, 'Liability Insurance', 30);
insert into SUCURSAL (cod_sucursal, nb_sucursal, cod_ciudad) values (33, 'All Insurance USA', 31);


insert into CLIENTE (cod_cliente, nro_documento, telefono, sexo, nb_cliente, email, direccion, cod_sucursal) 
